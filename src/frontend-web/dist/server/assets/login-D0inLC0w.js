import { a as getLastRegisteredUserId, c as saveAuthToken, l as saveAuthUser, m as Button, n as clearLastRegisteredUserId, o as loginUser, p as Input } from "./auth-service-C_vZ-nsD.js";
import { a as PasswordVisibilityButton, i as SocialAuthButton, o as AuthFeedbackMessage, r as SOCIAL_PROOF_IMAGES, t as GOOGLE_LOGIN_ICON_URL } from "./constants-Dc9uO3my.js";
...
function LoginPage() {
	...
	return /* @__PURE__ */ jsxs("main", {
		className: "flex min-h-screen flex-col overflow-hidden [overflow-wrap:normal] bg-background text-on-background lg:flex-row",
		children: [/* @__PURE__ */ jsxs("section", {
			className: "relative flex min-h-[48rem] flex-[1.2] flex-col justify-center overflow-hidden bg-background p-8 sm:p-12 lg:min-h-screen lg:p-24",
			children: [/* @__PURE__ */ jsx("div", {
				...
				children: [
					/* @__PURE__ */ jsxs("div", {
						className: "mb-12 inline-flex items-center gap-2 rounded-full bg-surface-container-lowest px-4 py-2 shadow-sm",
						children: [/* @__PURE__ */ jsx(Settings, {
							className: "h-4 w-4 text-on-surface",
							strokeWidth: 2
						}), /* @__PURE__ */ jsx("span", {
							className: "text-xs font-bold uppercase tracking-wider text-on-surface",
							children: "Modernidade Soft"
						})]
					}),
					/* @__PURE__ */ jsxs("h1", {
						className: "mb-8 text-5xl font-bold leading-tight text-on-surface",
						children: [
							"Bem-vindo ",
							/* @__PURE__ */ jsx("br", {}),
							/* @__PURE__ */ jsx("span", {
					...
					/* @__PURE__ */ jsx("p", {
						className: "mb-12 w-[min(100%,28rem)] text-lg leading-relaxed text-on-surface-variant",
			...
			children: [/* @__PURE__ */ jsxs("div", {
				className: "w-full max-w-[27.5rem] bg-surface-container-lowest rounded-[40px] px-8 py-12 shadow-card sm:px-10",
				"data-purpose": "login-form-card",
				children: [
					/* @__PURE__ */ jsx("h2", {
						className: "mb-1 text-2xl font-bold text-on-surface",
					...
					/* @__PURE__ */ jsxs("form", {
						...
						children: [
							/* @__PURE__ */ jsx(Input, {
								className: "!border-transparent !bg-[#e9ecef] focus:ring-primary",
								id: "user-id",
								inputMode: "numeric",
								label: "ID do usuário",
							...
							/* @__PURE__ */ jsx(Button, {
								className: "w-full hover:bg-primary-fixed-dim",
								color: "blueish",
					...
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsx("div", {
							...
							children: /* @__PURE__ */ jsx("span", {
								className: "bg-surface-container-lowest px-2 font-medium text-on-surface-variant",
					...
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsx(SocialAuthButton, {
							className: "h-[50px] flex-1 border-outline-variant bg-surface-container-lowest py-0 hover:bg-surface-container",
							imageAlt: "Google",
				...
				className: "mt-12 flex flex-wrap justify-center gap-x-12 gap-y-4 text-[10px] font-bold uppercase tracking-widest text-on-surface-variant",
				children: [
					/* @__PURE__ */ jsx("button", {
