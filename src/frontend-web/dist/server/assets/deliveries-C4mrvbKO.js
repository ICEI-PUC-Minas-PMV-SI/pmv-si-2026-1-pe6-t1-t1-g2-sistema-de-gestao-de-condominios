import { d as apiRequest, f as Modal, i as getAuthUser, m as Button, r as getAuthToken, t as clearAuthSession } from "./auth-service-DfJu0k8X.js";
...
function DeliveriesTable({ activeFilters, deletePending, deliveries, errorMessage, filteredDeliveries, isLoading, onClearFilters, onDeleteDelivery, onOpenFilterModal, onOpenReportModal, onRemoveFilter, showUsersWarning }) {
	return /* @__PURE__ */ jsxs("div", {
		className: "bg-white rounded-[2.5rem] soft-shadow border border-slate-50 overflow-hidden",
		children: [
			/* @__PURE__ */ jsxs("div", {
			...
			activeFilters.length > 0 && /* @__PURE__ */ jsxs("div", {
				className: "px-8 py-3 border-b border-slate-50 flex flex-wrap gap-2 items-center",
				children: [
					/* @__PURE__ */ jsx("span", {
						className: "text-[11px] font-semibold uppercase tracking-wider text-slate-400 mr-1",
			...
			/* @__PURE__ */ jsx("div", {
				...
				children: /* @__PURE__ */ jsxs("table", {
					...
					children: [/* @__PURE__ */ jsx("thead", { children: /* @__PURE__ */ jsxs("tr", {
						className: "text-slate-400 text-[10px] uppercase tracking-widest bg-slate-50/50",
						children: [
							/* @__PURE__ */ jsx("th", {
						...
						children: isLoading ? /* @__PURE__ */ jsx("tr", { children: /* @__PURE__ */ jsx("td", {
							...
							children: [
								/* @__PURE__ */ jsx("td", {
									...
									children: /* @__PURE__ */ jsxs("div", {
										...
										children: [/* @__PURE__ */ jsx("div", {
											className: "w-10 h-10 rounded-full bg-slate-100 flex items-center justify-center text-slate-400 overflow-hidden",
								...
								/* @__PURE__ */ jsx("td", {
									className: "px-8 py-5 text-sm text-slate-500 font-medium",
			...
			/* @__PURE__ */ jsxs("div", {
				className: "p-6 bg-slate-50/50 border-t border-slate-50 flex items-center justify-between",
...
function DeliverySidebar({ authUser, avatarUrl, displayName, onLogout, profileLabel }) {
	return /* @__PURE__ */ jsx("aside", {
		className: "h-screen w-64 fixed left-0 top-0 border-r border-outline-variant bg-surface-container-lowest text-sm font-medium z-50 rounded-tr-card rounded-br-card shadow-card",
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [
				/* @__PURE__ */ jsx("div", {
					...
					children: /* @__PURE__ */ jsxs("div", {
						className: "flex items-center gap-3",
						children: [/* @__PURE__ */ jsx("div", {
							className: "w-10 h-10 rounded-xl bg-primary flex items-center justify-center text-on-primary shadow-card",
				...
				/* @__PURE__ */ jsx("nav", {
					...
					children: navItems.map((item) => /* @__PURE__ */ jsxs("button", {
						className: item.active ? "flex w-full items-center gap-3 text-primary bg-surface shadow-card rounded-lg py-2 px-4 border-l-4 border-primary transition-all duration-200 ease-in-out" : "flex w-full items-center gap-3 text-on-surface-variant py-2 px-4 hover:text-on-surface hover:bg-surface-container-low rounded-lg transition-all duration-200 ease-in-out",
						type: "button",
						...
						children: [
							...
							/* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsx("p", {
									...
									className: `mt-0.5 inline-block rounded-full px-2 py-0.5 text-[10px] font-semibold leading-tight ${authUser?.profile?.toLowerCase() === "administrador" ? "bg-blue-100 text-blue-700" : "bg-emerald-100 text-emerald-700"}`,
...
function DeliveryStatsGrid({ totalDeliveries, stats }) {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [cards.map((card) => /* @__PURE__ */ jsxs("div", {
			...
			className: "bg-primary text-white p-6 rounded-[2rem] shadow-xl shadow-primary/20 relative overflow-hidden",
			children: [/* @__PURE__ */ jsxs("div", {
				className: "relative z-10",
				children: [
					/* @__PURE__ */ jsx("p", {
						className: "text-primary-fixed text-xs font-medium opacity-80",
