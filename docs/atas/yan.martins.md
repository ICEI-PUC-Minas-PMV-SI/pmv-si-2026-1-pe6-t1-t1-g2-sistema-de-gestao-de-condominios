# ATA de Acompanhamento - Yam Guimarães Martins
...
| 16/02 - 22/02 | Gestão de Serviços de TI - Unidade 2 | ✅  | Análise e levantamento inicial dos serviços | Levantamento da justificativa para a escolha do tema. |
| 23/02 - 01/03 | Arquitetura de Software Distribuído - Unidade 1 e 2 |✅  | Definição de Requisitos e Objetivos. | Apesentação doprojeto ao avaliador para aplicar as correções necessárias. |
