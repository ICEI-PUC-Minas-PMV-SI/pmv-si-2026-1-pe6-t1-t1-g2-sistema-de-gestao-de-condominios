...
export function ConfiguracoesModal({ authUser, onClose }: ConfiguracoesModalProps) {
			...
			>
				...
				<div className="flex flex-1 min-h-[500px]">
					...
					<section className="flex-1 p-10" data-purpose="profile-content">
						...
						{/* Profile Form */}
						<form id="profile-edit-form" className="space-y-6" data-purpose="profile-edit-form" onSubmit={handleSubmit}>
